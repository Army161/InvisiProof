...
export default function ProfileLayout() {
  return (
    <Stack screenOptions={{ headerShown: true }}>
      ...
      <Stack.Screen name="ai-provider" options={{ title: 'AI Provider', headerBackTitle: 'Profile' }} />
      ...
      <Stack.Screen name="subscription" options={{ title: 'Subscription & Billing', headerBackTitle: 'Profile' }} />
    </Stack>
  );
}
